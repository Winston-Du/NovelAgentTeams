---
name: crewai
description: Use when designing, configuring, or reviewing a CrewAI multi-agent system including agent roles, tasks, tools, orchestration, and process selection.
---
